 ...
 * the method getCurrentSumTimeSpent returns the the total time users spent playing your media in the last N minutes
 ...
 * getVideoHours and getAudioHours return the list of videos / audio by by hour (to see how your media is consumed at a different time of the day).
 * getVideoTitles and getAudioTitles return the list of videos / audio by video title and audio title.
...
trait MediaAnalytics {
    ...
    #[ArrayShape( [
        'nb_plays'                       => "int",
        'nb_unique_visitors_plays'       => "int",
        'nb_impressions'                 => "int",
        'nb_unique_visitors_impressions' => "int",
        'nb_finishes'                    => "int",
        'sum_total_time_watched'         => "int",
        'sum_total_audio_plays'          => "int",
        'sum_total_audio_impressions'    => "int",
        'sum_total_video_plays'          => "int",
        'sum_total_video_impressions'    => "int",
        'play_rate'                      => "float",
        'finish_rate'                    => "float",
    ] )]
    public function get( string $segment = '', string $columns = '', array $optional = [] ): array {
